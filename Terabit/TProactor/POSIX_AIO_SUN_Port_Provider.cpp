                                                   ...
                                                   int remain_mask)
{
    ...
    {
        ACE_ERROR ((LM_ERROR,
            ACE_TEXT("TRB_POSIX_AIO_SUN_Port_Provider::declare_interest: ")
            ACE_TEXT("fd=%d mask=%x %p\n"),
            fd,
            remain_mask,
            ACE_TEXT("port_associate failed")));
    }
...
//    {
//        ACE_ERROR ((LM_ERROR,
//            ACE_TEXT("TRB_POSIX_AIO_SUN_Port_Provider::clear_interest: ")
//            ACE_TEXT("fd=%d %p\n"),
//            fd,
//            ACE_TEXT("port_dissociate failed")));
//    }
    return rc;
}
