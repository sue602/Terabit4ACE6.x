...
TRB_WIN32_Asynch_Read_Stream_Result::start_read_generic ()
{
    ...
    return this->check_start_error ((rc==TRUE), ACE_TEXT("ReadFile"));
}
...
TRB_WIN32_Asynch_Read_Stream_Result::start_readv_stream ()
{
    ...
    return this->check_start_error ((rc==0), ACE_TEXT("WSARecv"));
}
...
TRB_WIN32_Asynch_Read_Stream_Result::start_readv_file ()
{
             ...
             ++i, ++buffer_pointers_count )
        {
            if (iov[i].iov_len != page_size)
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_TEXT ("TRB_WIN32_Asynch_Read_Stream_Result::start_readv_file:")
                    ACE_TEXT ("Invalid iov_len size\n")),
                    -1);
            }
    ...
    return this->check_start_error ((rc==TRUE), ACE_TEXT("ReadFileScatter"));
}
...
TRB_WIN32_Asynch_Write_Stream_Result::start_write_generic ()
{
    ...
    return this->check_start_error ((rc==TRUE), ACE_TEXT("WriteFile"));
}
...
TRB_WIN32_Asynch_Write_Stream_Result::start_writev_stream ()
{
    ...
    return this->check_start_error ((rc==0), ACE_TEXT("WSASend"));
}
...
TRB_WIN32_Asynch_Write_Stream_Result::start_writev_file ()
{
    ...
    if (this->original_.is_direct_buffers ())
    {
             ...
             ++i, ++buffer_pointers_count )
        {
            ...
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_TEXT ("TRB_WIN32_Asynch_Read_Stream_Result::start_writev_file:")
                    ACE_TEXT ("Invalid iov_len size\n")),
                    -1);
            }
    ...
    else
    {
             ...
             msg = msg->cont (), ++buffer_pointers_count )
        {
            ...
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_TEXT ("TRB_WIN32_Asynch_Write_Stream_Result::start_writev_file")
    ...
    return this->check_start_error ((rc==TRUE), ACE_TEXT("WriteFileGather"));
}
...
{ 
    ...
    return this->check_start_error ((rc==0), ACE_TEXT("WSARecvFrom"));
}
...
{ 
    ...
    return this->check_start_error ((rc==0), ACE_TEXT("WSASendTo"));
}
...
{ 
                         ...
                         0))
    {
        ...
        return this->check_start_error (false, ACE_TEXT("WSAIoctl for ConnectEx"));
    }
    ...
    int ret = this->check_start_error ((rc==TRUE), ACE_TEXT("ConnectEx"));
...
{ 
    ...
    else
    {
        ...
        if (space <  2*address_size)
        {
            errno = ENOSPC;
            ACE_ERROR_RETURN ((LM_ERROR, 
                ACE_TEXT ("TRB_WIN32_Asynch_Accept_Result::start:")
    ...
    if (original_.accept_handle () == ACE_INVALID_HANDLE)
    {
        ...
        if (accept_handle == ACE_INVALID_HANDLE)
        {
            ...
            {
                ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("TRB_WIN32_Asynch_Accept_Result::start:%p\n"),
    ...
    int ret = this->check_start_error ((rc==TRUE), ACE_TEXT("AcceptEx"));
...
{ 
    ...
    return this->check_start_error ((rc==TRUE), ACE_TEXT("TransmitFile"));
}
