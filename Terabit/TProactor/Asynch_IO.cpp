                           ...
                           int  reuse_addr)
{
    ...
    if (connect_handle == ACE_INVALID_HANDLE)
    {
        ...
        if (connect_handle == ACE_INVALID_HANDLE)
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_TEXT("%N:%l:TRB_POSIX_Asynch_Connect::prepare_connect:")
                ACE_TEXT(" ACE_OS::socket failed\n")),
                -1);
        }
        ...
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_TEXT("%N:%l:TRB_Asynch_Connect::prepare_connect:")
                ACE_TEXT(" ACE_OS::setsockopt failed\n")),
                -1);
        }
    }
             ...
             protocol_family == AF_INET6 )
    {
                            ...
                            protocol_family) == -1)
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_TEXT("%N:%l:TRB_Asynch_Connect::prepare_connect:")
                ACE_TEXT(" ACE_OS::bind_port failed\n")),
                -1);
        }
