          ...
          switch (errno)
            ...
            default:
              ...
              ACE_ERROR_RETURN ((LM_ERROR,
                                 ACE_TEXT ("%N:%l:(%P | %t):%p\n"),
                                 ACE_TEXT ("TRB_Proactor_Timer_Handler::svc:wait failed")),
                                -1);
            }
        }
    }
...
TRB_Proactor_Handle_Timeout_Upcall::proactor (TRB_Proactor &proactor)
{
  if (this->proactor_ == 0)
    ...
    ACE_ERROR_RETURN ((LM_ERROR,
                       ACE_TEXT ("TRB_Proactor_Handle_Timeout_Upcall is only suppose")
                                             ...
                                             const ACE_Time_Value &time)
{
  if (this->proactor_ == 0)
    ACE_ERROR_RETURN ((LM_ERROR,
                       ACE_TEXT ("(%t) No Proactor set in TRB_Proactor_Handle_Timeout_Upcall,")
  ...
  if (this->implementation_)
    {
      ...
      ACE_ERROR_RETURN ((LM_ERROR,
                       ACE_TEXT ("%N:%l:(%P | %t):%p\n"),
                       ACE_TEXT ("TRB_Proactor::close:implementation couldnt be closed")),
                      -1);
    }
